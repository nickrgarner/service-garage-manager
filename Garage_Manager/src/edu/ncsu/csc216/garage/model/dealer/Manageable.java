...
public interface Manageable {
	...
	/**
	 * Returns the Tiered item meeting the given filter and position from the list
	 * of items awaiting service.
	 * 
	...
	/**
	 * A string representation of the list of items awaiting service that meet the
	 * given filter.
	 * 
